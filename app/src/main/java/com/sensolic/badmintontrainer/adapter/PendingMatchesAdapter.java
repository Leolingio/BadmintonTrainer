...
public class PendingMatchesAdapter extends BaseAdapter {
    ...
    public PendingMatchesAdapter(Context context, List<Match> entryList) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.pending_matches_list_view, null);
            ...
            holder.openMatch = view.findViewById(R.id.openMatch);
            holder.deleteMatch = view.findViewById(R.id.deleteMatch);
        ...
        holder.openMatch.setTextSize(sizeText);
        holder.deleteMatch.setTextSize(sizeText);

        // open match button
        holder.openMatch.setOnClickListener(view1 -> {
            StatsActivity.showInfo(current);
            context.startActivity(new Intent(context, ReloadActivity.class));
        });

        // delete match button
        holder.deleteMatch.setOnClickListener(view1 -> {
            storage.deletePendingMatch(current.getMatchID());
